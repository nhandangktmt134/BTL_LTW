...
<head>
    ...
    <script type="application/ld+json" class="yoast-schema-graph">
    {
        ...
        "@graph": [{
            "@type": "CollectionPage",
            "@id": "https://nongsansach.com/trong-trot/",
            "url": "https://nongsansach.com/trong-trot/",
            "name": "Kiến Thức Trồng trọt - Nông Sản Sạch",
            "isPartOf": {
                "@id": "https://nongsansach.com/#website"
            },
            "primaryImageOfPage": {
                "@id": "https://nongsansach.com/trong-trot/#primaryimage"
            },
            "image": {
                "@id": "https://nongsansach.com/trong-trot/#primaryimage"
            },
            "thumbnailUrl": "https://nongsansach.com/wp-content/uploads/2022/02/cach-trong-bap-cai-2.jpg",
            "description": "Kiến Thức Trồng Trọt - Các bài viết chia sẻ kiến thức, kinh nghiệm cách trồng và chăm sóc các loại cây trồng, cây cảnh,hoa cảnh. Cách khắc phục sâu bệnh và bón phân sao cho hiệu quả",
            "breadcrumb": {
                "@id": "https://nongsansach.com/trong-trot/#breadcrumb"
            },
            "inLanguage": "vi"
        }, {
            "@type": "ImageObject",
    ...
    <link rel="alternate" type="application/rss+xml" title="Dòng thông tin chuyên mục Nông Sản Sạch &raquo; Trồng trọt"
        href="https://nongsansach.com/trong-trot/feed/" />
...
<body
        ...
        <div class="mobile-menu">
            <ul id="mobile-menu" class="menu">
                <li id="menu-item-4845"
                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-4845"><a
                        href="https://nongsansach.com/">Trang chủ</a><i class="sub-menu-toggle fas fa-angle-down"></i>
                </li>
                <li id="menu-item-277" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-277"><a
                        href="https://nongsansach.com/gioi-thieu/">Giới thiệu</a><i
                        class="sub-menu-toggle fas fa-angle-down"></i></li>
                <li id="menu-item-2273" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2273">
                    <a href="https://nongsansach.com/cua-hang/">Sản phẩm</a><i
                        class="sub-menu-toggle fas fa-angle-down"></i>
                </li>
                <li id="menu-item-166"
                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-166">
                    <a href="https://nongsansach.com/tin-tuc/">Kiến thức</a><i
                        class="sub-menu-toggle fas fa-angle-down"></i>
                    <ul class="sub-menu">
                        <li id="menu-item-4878"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-4878">
                            <a href="https://nongsansach.com/trong-trot/">Trồng trọt</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i>
                        </li>
                        <li id="menu-item-3519"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-3519"><a
                                href="https://nongsansach.com/huong-dan-trong-rau-sach/">Hướng dẫn trồng rau</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i></li>
                        <li id="menu-item-20046"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-20046"><a
                                href="https://nongsansach.com/nhan-giong/">Nhân Giống</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i></li>
                        <li id="menu-item-20047"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-20047"><a
                                href="https://nongsansach.com/choi-canh/">Chơi Cảnh</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i></li>
                        <li id="menu-item-20048"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-20048"><a
                                href="https://nongsansach.com/sau-benh/">Sâu Bệnh Hại Cây Trồng</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i></li>
                        <li id="menu-item-20045"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-20045"><a
                                href="https://nongsansach.com/phan-bon/">Phân Bón</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i></li>
                        <li id="menu-item-20015"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-20015"><a
                                href="https://nongsansach.com/suc-khoe-va-lam-dep/">Sức khỏe và làm đẹp</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i></li>
                        <li id="menu-item-3518"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-3518"><a
                                href="https://nongsansach.com/mon-an/">Món ăn</a><i
                                class="sub-menu-toggle fas fa-angle-down"></i></li>
                    </ul>
                </li>
                <li id="menu-item-170" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-170"><a
                        href="https://nongsansach.com/lien-he/">Liên hệ</a><i
                        class="sub-menu-toggle fas fa-angle-down"></i></li>
            </ul>
        </div>
    </div>
    <div id="page" class="site">
        ...
        <?phprequire_once("./view/footer.php"); ?>
    </div>
    <script>
    (function() {
