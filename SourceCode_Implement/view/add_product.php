      ...
      <div class="col">
        ...
        <div class="row g-0">
            <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">Tạo sản phẩm</h3>
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="sanpham_name" name="sanpham_name" class="form-control form-control-lg" required/>
                      <label class="form-label" for="sanpham_name">Tên sản phẩm</label>
                    </div>
                  </div>
                </div>
                <div class="form-outline mb-4">
                    <input type="text" id="sanpham_chitiet" name="sanpham_chitiet" class="form-control form-control-lg" required/>
                    <label class="form-label" for="sanpham_chitiet">Chi tiết</label>
                </div>
                
                <div class="form-outline mb-4">
                  <input type="text" id="sanpham_mota" name="sanpham_mota" class="form-control form-control-lg" />
                  <label class="form-label" for="sanpham_mota">Mô tả</label>
                </div>
               
                <div class="form-outline mb-4">
                  <input type="number" id="sanpham_gia" name="sanpham_gia" class="form-control form-control-lg" pattern="/^\+?\d{1,4}?[-.\s]?\(?\d{1,3}?\)?[-.\s]?\d{1,4}[-.\s]?\d{1,4}[-.\s]?\d{1,9}$/" required />
                  <label class="form-label" for="sanpham_gia">Giá</label>
                </div>
                <div class="form-outline mb-4">
                  <input type="number" id="sanpham_giakm" name="sanpham_giakm" class="form-control form-control-lg" pattern="/^\+?\d{1,4}?[-.\s]?\(?\d{1,3}?\)?[-.\s]?\d{1,4}[-.\s]?\d{1,4}[-.\s]?\d{1,9}$/" required />
                  <label class="form-label" for="sanpham_giakm">Giá KM</label>
                </div>
                <div class="form-outline mb-4">
                    <input type="checkbox" name="sanpham_hot" id="sanpham_hot" value="1">
                  <label class="form-label" for="sanpham_hot">Sản phẩm hot</label>
                </div>
                <div class="form-outline mb-4">
                  <input type="number" id="sanpham_soluong" name="sanpham_soluong" class="form-control form-control-lg" pattern="/^\+?\d{1,4}?[-.\s]?\(?\d{1,3}?\)?[-.\s]?\d{1,4}[-.\s]?\d{1,4}[-.\s]?\d{1,9}$/" required />
