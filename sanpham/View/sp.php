        ...
        <div class="shop-filter row">
            <div class="shop-filter-left col-md-6">
                <p class="woocommerce-result-count">
                    Showing 1 &ndash; 6 of 15 results 
                </p>
            </div>
                        ...
                        <div class="product-thumb">
                            ...
                            <div class="product-action">
                                <span class="add-to-cart-btn hint--top hint--rounded hint--bounce" aria-label="Thêm vào giỏ hàng">
                                    <a href="" data-quantity="1" id="id_sp" name="name_sp" class="button wp-element-button product_type_simple add_to_cart_button ajax_add_to_cart" id="id_sp" name="name_sp" aria-label="Thêm &ldquo;name_sp&rdquo; vào giỏ hàng" rel="nofollow">
                                        Thêm vào giỏ hàng
                                    </a>
                                </span>
                                <div class="quick-view-btn hint--top hint--rounded hint--bounce" aria-label="Quick view">
                                    <a href="" class="woosq-btn woosq-btn-19148" id="id_sp" data-effect="mfp-3d-unfold" data-context="default">
                                        Xem nhanh
                                    </a>
                                </div>
                            </div>
